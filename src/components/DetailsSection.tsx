  ...
  return (
    <section className="details-section" id="detailsSection">
      <div className="content-container">
        {/* Bismillah */}
        <div className="bismillah-arabic">بِسْمِ اللَّهِ الرَّحْمَٰنِ الرَّحِيمِ</div>
        ...
        <div className="person-card">
          ...
          <h2 className="person-name">Syed Saima Tasneem</h2>
          ...
          <div className="parent-designation">Class I Officer, Education Department, Nanded</div>
        </div>
        ...
        <div className="person-card">
          ...
          <h2 className="person-name">Syed Nizamuddin</h2>
        ...
        <div className="hadith-card">
          <div className="hadith-arabic">
            عَنِ ابْنِ عَبَّاسٍ قَالَ: قَالَ رَسُولُ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ:
            <br />
          ...
          <div className="hadith-quote">
            &quot;There is nothing like marriage, for two people who love one another.&quot;
          </div>
        </div>
      </div>
    </section>
